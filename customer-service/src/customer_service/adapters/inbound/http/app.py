...
from customer_service.adapters.inbound.http.routes import customer_bp
from customer_service.adapters.outbound.persistence.models import Base
from customer_service.config.settings import SERVICE_NAME, database_url
